...
START_IMG_URLS = "https://graph.org/file/ff6863675a4357be2ffa9.jpg"
    ...
    [
        [
            InlineKeyboardButton(
                "๏ @ceo_of_secularism ๏",
                url=f"https://t.me/crazy_hunter1",
            )
        ]
    ]
)
...
🔐ᴜꜱᴇ » [/start](https://t.me/crazy_hunter1?start=help) ᴛᴏ ᴄʜᴇᴄᴋ ʙᴏᴛ

➲ ʙᴏᴛ :** @ceo_of_secularism"""
...
BUTTON = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "๏ ᴋɪᴅɴᴀᴘ ᴍᴇ ๏",
                url=f"https://t.me/crazy_hunter1?startgroup=s&admin=delete_messages+manage_video_chats+pin_messages+invite_users",
            )
        ]
    ]
)
