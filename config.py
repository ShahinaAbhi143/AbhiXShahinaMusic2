...
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 9009))

# Chat id of a group for logging bot's activities
LOGGER_ID = int(getenv("LOGGER_ID", None))
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002247930105"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/crazy_hunter1")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/crazy_hunter_chat")
